...
class CourseBookingSuccess extends StatefulWidget {
  final String courseName;
  final String bookingPrice;
  final String courseBookingId;
  const CourseBookingSuccess({
    super.key,
  ...
  @override
  State<CourseBookingSuccess> createState() => _CourseBookingSuccessState();
}

class _CourseBookingSuccessState extends State<CourseBookingSuccess> {
  @override
