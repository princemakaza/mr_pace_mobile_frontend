...
class PayRegistration extends StatefulWidget {
  ...
  @override
  State<PayRegistration> createState() => _PayRegistrationState();
}

class _PayRegistrationState extends State<PayRegistration> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Registration Number: ${widget.registration_number}',
                      ...
                      Text(
                        'Amount to Pay: \$${widget.registrationPrice}',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                ...
                GestureDetector(
                  onTap: () async {
                    await _paymentHelper.submitPayment(
                      registrationNumber: widget.registration_number,
