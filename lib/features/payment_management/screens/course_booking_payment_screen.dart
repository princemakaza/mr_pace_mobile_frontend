...
class CourseBookingPayment extends StatefulWidget {
  final String courseBookingPrice;
  final String courseBookingId;
  final String courseName;

  const CourseBookingPayment({
    super.key,
    required this.courseBookingPrice,
    required this.courseBookingId,
    required this.courseName,
  });

  @override
  State<CourseBookingPayment> createState() => _CourseBookingPaymentState();
}

class _CourseBookingPaymentState extends State<CourseBookingPayment> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Amount to Pay: \$${widget.courseBookingPrice}',
                ...
                GestureDetector(
                  onTap: () async {
                    await _paymentHelper.submitCoursebookingPayment(
